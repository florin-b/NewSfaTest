...
public class CreareComanda extends Activity implements AsyncTaskListener, ValoareNegociataDialogListener, ComenziDAOListener, PretTransportDialogListener,
	...
	private void setLivrariMathaus(String result) {
		...
		for (ArticolComanda articolComanda : articoleComandaDistrib) {
			...
			if (!articolComanda.getArticolMathaus().getTip2().equals("S")) {
	...
	private void afisRezumatComandaDialog(List<CostTransportMathaus> costTransport) {
		...
		RezumatComandaDialog rezumatComanda = new RezumatComandaDialog(this, ListaArticoleComanda.getInstance().getListArticoleComanda(), "10", costTransport);
