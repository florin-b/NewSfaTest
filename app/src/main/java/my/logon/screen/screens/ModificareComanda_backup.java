...
public class ModificareComanda_backup extends Activity implements AsyncTaskListener, ComenziDAOListener, ArticolModificareListener, Observer, CostMacaraListener,
    ...
    public void showModifValTranspDialogBox() {
        final Dialog dialogModifValTransp = new Dialog(ModificareComanda_backup.this);
        ...
        ArticolePretTransport adapterArticoleTransport = new ArticolePretTransport(ModificareComanda_backup.this, listArticoleComanda);
        ...
        aprobareBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    AprobariDialog aprove = new AprobariDialog(ModificareComanda_backup.this);
            ...
            case 0:
                if (codClientVar.length() > 0) {
                    ...
                    if (isUserCV() || isComandaGed()) {
                        ...
                        nextScreen.putExtra("canalDistrib", ModificareComanda_backup.isComandaDistrib ? "10" : "20");
                ...
                try {
                    ...
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_DOWN:
                            ...
                            if (!selectedCmdAdrLivr.equals(selectedCmd) && !selectedCmdAdrLivr.trim().isEmpty()) {
    ...
    private boolean isConditiiSolicitCnp() {
        ...
        if (!ModificareComanda_backup.tipClientVar.equals("PF"))
            return false;
    ...
    private void showCnpDialog() {
        ...
        dialog.setCnpListener(ModificareComanda_backup.this);
        dialog.show();
    }
                    ...
                    public void run() {
                        ...
                        if (dateLivrareInstance.getObsPlata().equals("SO") && dateLivrareInstance.getTipPlata().equals("E")) {
                            if (!dateLivrareInstance.isValIncModif()) {
                                dateLivrareInstance.setValoareIncasare(nf3.format(ModificareComanda_backup.totalComanda * Constants.TVA));
                            }
                        }
                        ...
                        comandaFinala.setFilialaAlternativa(ModificareComanda_backup.filialaAlternativaM);
    ...
    public String prepareArtForDelivery() {
        ...
        if (ModificareComanda_backup.isComandaDistrib) {
            if (hasTaxaVerde) {
    ...
    private String serializeArticole() {
        ...
        if (!ModificareComanda_backup.isComandaDistrib && !UtilsUser.isAgentOrSDorKA() && !isExceptieComandaIP() && valTransport > 0) {
            UtilsComenziGed.setValoareArticolTransport(listArticoleComanda, valTransport);
        }
    ...
    private String serializeComanda(Comanda comanda) {
        ...
        try {
            ...
            obj.put("canalDistrib", ModificareComanda_backup.isComandaDistrib ? "10" : "20");
