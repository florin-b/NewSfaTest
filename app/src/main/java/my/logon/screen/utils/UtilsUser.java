...
public class UtilsUser {
    ...
    public static List<Agent> getListFromHash(ArrayList<HashMap<String, String>> hashAgenti) {
        ...
        for (HashMap<String, String> mapValue : hashAgenti) {
            Agent agent = new Agent();
            agent.setNume(mapValue.get("numeAgent"));
            agent.setCod(mapValue.get("codAgent"));
            agent.setDepart(mapValue.get("depart"));
