...
public class OperatiiObiective implements AsyncTaskListener {
    ...
    public ObiectivConsilier deserializeInfoObiectiv(String result) {

        ObiectivConsilier obConsilier = new ObiectivConsilier();
        ...
        try {
            ...
            if (jsonObject instanceof JSONObject) {
                ...
                obConsilier.setBeneficiar(jsonObject.getString("Nume"));
                obConsilier.setDataCreare(jsonObject.getString("Data"));
                obConsilier.setAdresa(jsonObject.getString("Localitate") + ", " + jsonObject.getString("Strada"));
                obConsilier.setCodJudet(jsonObject.getString("Judet"));
